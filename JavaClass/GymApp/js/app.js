const exercises = [
    new Exercise('Legs Extensions','images/legex.jpg','The exercise works mainly the quadriceps muscles of the front of the thigh—the rectus femoris and the vastusmuscles.','400','4reps'),
    new Exercise('Bench Press','images/legex.jpg','The exercise works mainly the quadriceps muscles of the front of the thigh—the rectus femoris and the vastusmuscles.','400','4reps'),
];
...
function showExercises(){
    exercises.forEach(exercise => {
        ...
        div_desc_element.classList.add('card-content');
