const exercises = [
    new Exercise(
        "Squat",
        "images/squat.jpg",
        "The exercise works mainly the quadriceps muscles of the front of the thigh—the rectus femoris and the vastusmuscles.",
        "400",
        "4reps",
        "legs"
    ),
...
const exercises2 = {
    pierna: [
        { nombre: "Squat", desc: "Squad Desc" },
        { nombre: "Racks", desc: "Racks Desc" },
    ],
    chest: [
        { nombre: "press", desc: "press Desc" },
